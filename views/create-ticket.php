...
?>
<!-- SideNavBar Shell -->
<aside class="flex flex-col h-screen fixed left-0 top-0 py-margin-xl bg-surface dark:bg-inverse-surface docked h-full w-64 border-r border-outline-variant dark:border-outline z-40 hidden md:flex">
  ...
  <nav class="flex-1 px-margin-md space-y-margin-sm">
    <a class="flex items-center gap-margin-md px-margin-lg py-margin-md rounded-lg text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-high dark:hover:bg-secondary-container transition-all scale-98 active:scale-95 duration-200" href="?page=dashboard">
      <span class="material-symbols-outlined">dashboard</span>
      <span class="font-label-sm text-label-sm">Panel</span>
    </a>
    <a class="flex items-center gap-margin-md px-margin-lg py-margin-md rounded-lg text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-high dark:hover:bg-secondary-container transition-all scale-98 active:scale-95 duration-200" href="?page=tickets">
      <span class="material-symbols-outlined">confirmation_number</span>
      <span class="font-label-sm text-label-sm">Incidencias</span>
    </a>
    <!-- Active Tab: Create Ticket -->
    <a class="flex items-center gap-margin-md px-margin-lg py-margin-md rounded-lg text-primary dark:text-inverse-primary font-bold border-r-4 border-primary bg-surface-container dark:bg-surface-container-low shadow-sm scale-98 active:scale-95 duration-200" href="?page=create-ticket">
      <span class="material-symbols-outlined">add_circle</span>
      <span class="font-label-sm text-label-sm">Nueva Incidencia</span>
    </a>
    <a class="flex items-center gap-margin-md px-margin-lg py-margin-md rounded-lg text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-high dark:hover:bg-secondary-container transition-all scale-98 active:scale-95 duration-200" href="?page=admin">
      <span class="material-symbols-outlined">admin_panel_settings</span>
      <span class="font-label-sm text-label-sm">Administración</span>
    </a>
    <a class="flex items-center gap-margin-md px-margin-lg py-margin-md rounded-lg text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-high dark:hover:bg-secondary-container transition-all scale-98 active:scale-95 duration-200" href="?page=statistics">
  ...
  <div class="px-margin-md mt-auto pt-margin-xl border-t border-outline-variant">
    <a class="flex items-center gap-margin-md px-margin-lg py-margin-md rounded-lg text-on-surface-variant dark:text-surface-variant hover:bg-surface-container-high transition-all" href="#">
