...
?>
<!-- Sidebar Shell -->
<aside class="flex flex-col h-screen fixed left-0 top-0 py-margin-xl bg-surface docked w-64 border-r border-outline-variant shadow-sm z-40">
  <div class="px-6 mb-8">
  ...
  <nav class="flex-1 px-4 space-y-1">
    <a class="flex items-center gap-3 px-4 py-3 font-body-md text-body-md text-on-surface-variant hover:bg-surface-container-high transition-all scale-98 active:scale-95 duration-200" href="?page=dashboard">
      <span class="material-symbols-outlined" data-icon="dashboard">dashboard</span>
      Panel
    </a>
    <a class="flex items-center gap-3 px-4 py-3 font-body-md text-body-md text-on-surface-variant hover:bg-surface-container-high transition-all scale-98 active:scale-95 duration-200" href="?page=tickets">
      <span class="material-symbols-outlined" data-icon="confirmation_number">confirmation_number</span>
      Incidencias
    </a>
    <a class="flex items-center gap-3 px-4 py-3 font-body-md text-body-md text-on-surface-variant hover:bg-surface-container-high transition-all scale-98 active:scale-95 duration-200" href="?page=create-ticket">
      <span class="material-symbols-outlined" data-icon="add_circle">add_circle</span>
      Nueva Incidencia
    </a>
    <a class="flex items-center gap-3 px-4 py-3 text-primary font-bold border-r-4 border-primary bg-surface-container-low transition-all scale-98 active:scale-95 duration-200" href="?page=admin">
    ...
    <a class="flex items-center gap-3 px-4 py-3 font-body-md text-body-md text-on-surface-variant hover:bg-surface-container-high transition-all scale-98 active:scale-95 duration-200" href="?page=statistics">
  ...
  <div class="mt-auto px-4 border-t border-outline-variant pt-4">
    <a class="flex items-center gap-3 px-4 py-3 font-body-md text-body-md text-on-surface-variant hover:bg-surface-container-high transition-all" href="#">
